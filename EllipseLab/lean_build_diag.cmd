...
(
  ...
  echo ^)
  echo echo.
  echo echo ===== EllipseLab.lean =====
  echo if exist "EllipseLab.lean" ^(
  echo   type "EllipseLab.lean"
  echo ^) else ^(
  echo   echo EllipseLab.lean not found
  echo ^)
  echo echo.
  echo echo ===== EllipseLab\Shape.lean =====
  echo if exist "EllipseLab\Shape.lean" ^(
  echo   type "EllipseLab\Shape.lean"
  echo ^) else ^(
  echo   echo EllipseLab\Shape.lean not found
  echo ^)
  echo echo.
  echo echo ===== lake env =====
  echo lake env
