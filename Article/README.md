...
The complete Lean theorem described by the paper is `EllipseOmega.ellipse_perimeter_series` in `../EllipseLab/EllipseLab/Shape.lean`. The partial `../EllipsePerimeter/` package does not contain that final theorem.
