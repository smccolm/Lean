...
def auditedDeclarations : Array Name := #[
  ...
  ``RiemannZeta.GuthMaynard.zeta_abs_convergent_at_2,
  ``RiemannZeta.GuthMaynard.mobius_sum_rhs_nonneg,
  ``RiemannZeta.GuthMaynard.mobius_sum_bound,
  ``RiemannZeta.GuthMaynard.exp_smoothing_bound,
  ``RiemannZeta.GuthMaynard.detector_coeff_bound_native,
  ...
  ``RiemannZeta.GuthMaynard.divisor_bound_native,
  ...
  ``RiemannZeta.GuthMaynard.jensens_inequality_disk,
  ...
  ``RiemannZeta.GuthMaynard.typeII_dyadic_sum,
  ``RiemannZeta.GuthMaynard.typeII_bound_of_halasz_montgomery_native,
  ``RiemannZeta.GuthMaynard.recursive_block_decomposition,
