...
A fresh primary-source check found Huxley's
[1991 Bombieri–Iwaniec survey](https://www.numdam.org/article/AST_1991__198-199-200__165_0.pdf),
which records Watt's `89/560` estimate and identifies its coincidence
input. This is reference guidance, not a formal proof of the needed pair.
The [Sargos 1995 publisher entry](https://doi.org/10.1112/plms/s3-70.2.285)
still provides only abstract/purchase access here, not the full
Theorem 7.1 argument. No source pin or claimed Lean dependency was changed.
...
This continuation used the unchanged printed `add-bound(ii)` and local
kernel-checked APIs: [native Euler–Maclaurin](<../71 Guth-Maynard, 2026/GuthMaynard/ZetaTruncation.lean>),
[Mathlib Young inequality](../../.lake/packages/mathlib/Mathlib/Analysis/MeanInequalities.lean),
and [harmonic bounds](../../.lake/packages/mathlib/Mathlib/NumberTheory/Harmonic/Bounds.lean).
No new source pin, assumed literature theorem, or external solver was added.
...
This continuation uses the existing actual growth definition, the completed
real-moment transfer and the kernel-checked discreteness/pointwise bridges.
No source pin, external theorem premise or solver dependency was added.
...
The strengthened transfer uses local kernel-checked ingredients: the native
Dirichlet mean-square identity and Hilbert-form error, actual sharp
coefficient-one phases, arbitrary-order cutoff derivatives and the exact
power-tail integral. No source pin or external theorem premise changed.
...
Additional source research for the next open branch:
[Ivic, Large Values of the Zeta-Function on the Critical Line, Theorem 2](https://www.researchgate.net/publication/294286783_Large_Values_of_the_Zeta-Function_on_the_Critical_Line)
gives the general exponent-pair counting route through actual Atkinson
phase differences. The [current ANTEDB zeta-large-values chapter, Lemma 8.11](https://teorth.github.io/expdb/blueprint/largevalue-zeta-chapter.html)
and [moment chapter, Corollaries 9.13–9.14](https://teorth.github.io/expdb/blueprint/zeta-moment-chapter.html)
identify the restricted-sixth-moment threshold 11/72. These are research
references, not Lean inputs or an assertion that the unrestricted
low-height blueprint statement is valid. The frozen source pins are unchanged.
...
The analytic route remains the actual phase-difference argument in
Ivic's author-uploaded [Large Values of the Zeta-Function on the Critical
Line](https://www.researchgate.net/publication/294286783_Large_Values_of_the_Zeta-Function_on_the_Critical_Line),
Lemma 2 and Theorem 2, and the
[current large-value blueprint](https://teorth.github.io/expdb/blueprint/largevalue-zeta-chapter.html).
This checkpoint proves the model entry and finite Gram consumers,
not the final counting theorem. The
[restricted-moment blueprint](https://teorth.github.io/expdb/blueprint/zeta-moment-chapter.html)
identifies the sixth-moment threshold targeted by the derived pair.
No archive pin or frozen public contract was changed.
...
This continues the actual phase-difference and finite localization argument in
Ivic's author-uploaded [Large Values of the Zeta-Function on the Critical
Line](https://www.researchgate.net/publication/294286783_Large_Values_of_the_Zeta-Function_on_the_Critical_Line),
Lemma 2 and Theorem 2. The physical packet and local-mean count are now
proved, while the pointwise-zeta and restricted-moment consumers remain
unfinished. The [current large-value blueprint](https://teorth.github.io/expdb/blueprint/largevalue-zeta-chapter.html)
and [moment blueprint](https://teorth.github.io/expdb/blueprint/zeta-moment-chapter.html)
remain guides to those consumers, not substitute Lean premises.
No source pin or frozen publication contract was changed.
...
The actual peak count follows the phase/localization route in
Ivic's [Large Values of the Zeta-Function on the Critical Line](https://www.researchgate.net/publication/294286783_Large_Values_of_the_Zeta-Function_on_the_Critical_Line),
Theorem 2, for the proved pair `(2/9,11/18)`.
The threshold agrees with the
[current restricted-moment blueprint](https://teorth.github.io/expdb/blueprint/zeta-moment-chapter.html).
The Lean proof retains the complete measured superlevel set and does
not assume the moment conclusion or an unrestricted sixth moment.
No source pin or frozen publication contract was changed.
...
Bourgain's [IHES preprint, section IV](https://repo-archives.ihes.fr/FONDS_IHES/I_Prepublications/BOURGAIN/1990-1995/M_93_51/M_93_51_web.pdf),
equations (4.17)--(4.25), was checked for the separate general-coefficient
route. It applies the restricted sixth moment to the Gram argument;
its threshold is `M^(2*sigma-3/2)>T^(11/72)`. The new zeta-pattern
transfer is independently proved but does not complete that step.
No source pin or frozen publication contract was changed.
...
Bourgain's [IHES preprint, section IV](https://repo-archives.ihes.fr/FONDS_IHES/I_Prepublications/BOURGAIN/1990-1995/M_93_51/M_93_51_web.pdf),
equations (4.17)--(4.26), supplies the source route. The Lean development
now proves its general-coefficient restricted-sixth consumer and both
density branches from actual upstream results. The pinned paper's
`bourgain-zero-density-optimized` lists the next eight pairs; their
rational data alone do not establish their analytic exponent-pair status.
No source pin or frozen publication contract was changed.
...
Source-provenance check: the pinned paper's proof of
`bourgain-zero-density-optimized` explicitly invokes closure. The new
Lean convex-limit theorem discharges that step. The frozen
`zero_density_estimate.py` entries do not contain proofs of their
listed pairs. The D-process reference is Sargos, *Proc. London Math.
Soc.* 70 (1995), 285--312, Theorem 7.1
([publisher record](https://doi.org/10.1112/plms/s3-70.2.285)).
The online publisher PDF was not accessible during this check; no
inaccessible content or unchecked literature claim was imported as an axiom.

An independent older-pair route is described in Robert--Sargos,
*A Fourth Derivative Test for Exponential Sums*, Compositio Math. 130
(2002), 275--292 ([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
Theorem 1, Theorem 2 and the actual-phase reduction in Section 4 are
research inputs only; this checkpoint does not claim their Lean proofs.
...
Primary source: Robert--Sargos, *A Fourth Derivative Test for Exponential
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
The new arithmetic theorem realizes Lemma 5 with an explicit constant;
the source conic consumer realizes the fixed-coefficient step in Section
3.3(b). Theorem 2 and Theorem 1 remain open. The Section 4 phase correction
is preserved in `robertSargos_actual_to_counting_tolerance`.
No inaccessible source or external computation is used as proof evidence.
...
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
This checkpoint implements the coefficient-ratio, pivot and narrow-band
ingredients of Section 3.3(c), with explicit finite counts and uniform
epsilon losses. The primitive system is a closed-support overcount of
(3.4)--(3.6). The total Lemma 7, Theorem 2 and Theorem 1 remain open.
...
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
This checkpoint completes the finite-set primitive bound of Lemma 7,
Section 3.3, for the actual system (3.4)--(3.6), with closed-support
overcounting and the additional delta-zero endpoint. Direct signed
harmonic summation replaces the dyadic displacement argument.
Lemma 6's seven-variable reduction, Theorem 2 and Theorem 1 remain open.
...
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
This checkpoint proves the literal finite-set bound of Theorem 2,
(3.1)--(3.3), with a checked half-open source entry. The two-gcd
reduction uses the enlarged integer-supported frequency scale
`max(1,Q/k)`, followed by exact harmonic summation. This replaces
the separate exceptional-range treatment in Section 3.2 without
weakening the source conclusion. Theorem 1 remains open.
...
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
The new modules implement the finite rectangular core of Lemma 1,
the actual cubic coordinates and C4 remainder estimates in Section 4,
and the Step 7 Taylor-to-counting reduction with its correction budget.
The zero-based rectangle and local ordinary-derivative conventions
are explicit. Source-specific support consumers, multiple partial
summation, double-large-sieve and Theorem 1 remain open.
...
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
The new source entry realizes Lemma 1 on its literal one-based rectangle.
The Section 4 symmetric-phase array is consumed with both h and h+r
supports. Replacing the m intersection by its r=0 interval incurs a
proved error; no omitted endpoint convention is treated as equality.
The initial A-process, zero shifts and subsequent steps of Theorem 1
remain open.
...
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
The new modules realize the initial conjugated A-process and the
full doubled-block reduction of Section 4, Step 1, equations (4.3)--(4.6),
with literal one-based phase intervals and explicit constants.
The subsequent small-block third-derivative argument, zero shifts,
later analytic steps and Theorem 1 are not claimed complete.
...
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
The new modules realize the finite shifted averaging and reordering
of Section 4, Step 3, with a rigorously corrected common core and an
explicit boundary charge. The displayed J0/J3 containments are not
assumed. Zero-shift estimates, subsequent analytic steps and Theorem 1
...
Primary source context: Robert--Sargos, *A Fourth Derivative Test for
Exponential Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)),
Sections 2.3 and 4. The new ordinary third-derivative theorem is an
independent Weyl/second-derivative derivation using the audited native
foundation. It does not assert the sharper printed Lemma 3. Its use
in the source small-block and zero-shift budgets remains to be proved.
...
Sums*, Compositio Math. 130 (2002), 275--292
([author-hosted paper](https://perso.univ-st-etienne.fr/rool6510/compositiorobertsargos.pdf)).
The new source consumers realize the small-block part of Section 4,
Step 1, including the actual selected block and physical floor scale.
They use the independently proved ordinary third-derivative estimate;
...
Primary analytic source: Robert--Sargos, 2002,
