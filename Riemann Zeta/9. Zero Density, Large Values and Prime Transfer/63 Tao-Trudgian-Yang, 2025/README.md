...
The four new exponent pairs and optimized density output still require their
analytic derivations. The old pair, its zeta-growth consequence and full improved
Heath--Brown density output are now proved. Deterministic archived-recipe
reproduction remains separate.
...
moment. Its consumer
`energyClauseOne` assembles the full clause without an analytic premise.
The independent endpoint-two transfer and exact bounded-supremum corollary
are now also proved under EPZAE-33; the original clause-(i) route is preserved.
