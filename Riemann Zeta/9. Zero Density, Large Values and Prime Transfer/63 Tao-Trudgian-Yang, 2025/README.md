...
source domain. The full-domain Add-est (i)--(ii) are now proved in `NewAdditiveEnergy.lean`.
The four exponent pairs, density outputs and other seven energy clauses
