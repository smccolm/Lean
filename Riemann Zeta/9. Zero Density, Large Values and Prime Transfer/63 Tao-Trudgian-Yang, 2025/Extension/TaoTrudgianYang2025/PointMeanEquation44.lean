...
overlap theorem.  The first consumer exposes Lemma 3 as a narrower upstream hypothesis; the final
consumer discharges it with the locally proved contour and tail argument.
This point-entry estimate does not itself prove the twelfth-moment theorem.
-/
