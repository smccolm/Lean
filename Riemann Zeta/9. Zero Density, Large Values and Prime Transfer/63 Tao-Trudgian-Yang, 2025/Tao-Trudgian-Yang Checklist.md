...
- [ ] **EPZAE-19 -- Classical LV inputs.** Exact consumed Huxley, Jutila,
  ...
  The standalone uniform Huxley `LV` API and other listed inputs remain open.
...
- [ ] **EPZAE-36 -- Energy optimization certificates.** Every projection and
  ...
  actual uniform consumers in `EnergyClauseTwo`; the other seven clauses'
  projections and the full release gate remain open.
- [ ] **EPZAE-37 -- Nine new energy estimates.** Every clause of `Add-est` is
  ...
  EPZAE-33's independent source endpoint-two theorem and clauses (iii)--(ix)
  remain in the full completion contract; EPZAE-37 stays unchecked.
