...
try {
    ...
    Write-Host 'MILESTONE: unconditional eventual Lemma 3.1 quadratic-window scale and H/400 measure lower bound, plus the complete fixed-constant logarithmic contradiction conditional on specialized Theorem 2.5, verified.'
    ...
    Write-Host 'MILESTONE: Lemma 4.2 large-P spine at P=H log^2 N, including prime exclusion, an explicit normalized smooth plateau cutoff, exact zero prime sum, reciprocal mass lower bound, Theorem 2.5 upper bound, and their logarithmic sandwich, verified.'
