...
| Erdős--Selfridge input | Theorem 1.1(ii), used after Theorem 1.10 | Original Theorem 1 specialized to exponent two | No Lean endpoint yet | Original paper pinned and hashed; no completed external Lean proof found |
