flowchart TD
    ...
    subgraph SECTION3["Section 3: very bad intervals"]
        direction TB
        VBSHORT["Lemma 3.1<br/>H&lt;N + exact 0.9 obstruction/smooth cutoff/T2.5 upper and parameter bridge proved;<br/>lower bound reduced to inner-good-set measure ≫H"]
