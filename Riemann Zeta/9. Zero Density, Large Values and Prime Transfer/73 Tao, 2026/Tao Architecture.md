flowchart TD
    ...
    subgraph SECTION3["Section 3: very bad intervals"]
        direction TB
        VBSHORT["Lemma 3.1<br/>H&lt;N + obstruction/cutoff/T2.5 upper + both substitutions + periodic slice + unit-cell insertion + unconditional eventual PNT/binomial scale and measure lower bound proved + fixed-constant logarithmic contradiction packaged;<br/>open: specialized Theorem 2.5 estimate only"]
    ...
    subgraph SECTION4["Section 4: type F3 and factorial equation"]
        direction TB
        FBOUNDS["PROVED Lemma 4.1 + Lemma 4.2 large-P spine<br/>normalized plateau + reciprocal mass<br/>zero sum + T2.5 sandwich"]
