# Lean Alignment Checklist

**Established:** 8 August 2026  
**Authority:** `../../AGENTS.md`, `Research Agenda Progress.MD`, and `../../Publication Readiness and Semantic Audit.md`

**Historical objective:** `../../archive/Guth_Maynard_Formalization_Research_Agenda_2026-08-03.docx` is retained for provenance but is not a current operating directive.

Paths recorded in the chronological sections below are project-root-relative unless explicitly described as module names. The three live Guth–Maynard status documents now reside together in this node-71 directory.
...
## Checklist #20 — Publication Readiness and External Proof Digestion
...
Historical entries below preserve the filenames of contemporaneous transient
runner logs. Those ignored log files were intentionally removed during
repository sanitation; rerun the canonical verifier for current evidence.
...
| Canonical quiet verifier | **Complete internally** | `scripts/verify_release.ps1` is the maintained local authority; it fails on warnings, tactic suggestions, linter findings, proof escapes, contract mismatches, audit failures, and unclassified modules. |
| Provenance and retired hosted CI | **Complete locally; historical hosted mirror inconclusive** | Release mode refuses dirty trees and records SHA, branch, paths, time/timezone, Lean/Lake/toolchain/dependencies, verifier hash, contract version, classifications, and stages. GitHub runs `33258211182` and `33278864901` ended with external exit `143` before artifact upload; neither produced a Lean diagnostic or hosted PASS. The heavyweight workflows were subsequently retired. |
| Safe Git workflow | **Complete** | `push_to_github.bat` resolves the repository root, stages all nonignored changes with `git add -A`, rejects empty messages, verifies that no nonignored changes remain unstaged or uncommitted, checks each command, permits a no-change synchronization run, and performs only non-force pushes of `main` and annotated tags. It does not run builds or poll hosted CI. The owner executed the synchronization. |
| Documentation/source freeze | **Complete internally** | Root/project README, comments, agendas, architecture, paper, semantic audit, citation metadata, and `verification/SOURCE_FREEZE.md` distinguish kernel/project verification from external review, publication, and canonicalization. |
| Clean-clone tagged release | **Complete at the local release gate** | Exact commit `2ace9e7c09a69fdcd1edae1ab6deb7cb3b4df1be`, published annotated tag `gm-foundation-freeze-v1.0.1`, passed the canonical release verifier from a fresh short-path clone. No hosted PASS is claimed. |
...
| Finding | Affected Checklist items | Corrected assessment |
|---|---|---|
...
### Authoritative Audit of Checklist #1–#14
...
Checklist #15–#19 were ordered by dependency, not by estimated effort. Each item had a bounded mathematical responsibility and an objective completion test. All five now meet those tests.
...
|---:|---|---|---|
| 1 | ~~`9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/TestAxiom.lean`~~ | **Completed 8 August 2026:** deleted the isolated file containing the deliberately false axiom and its dependent theorem. | Trivial—complete |
...
| 4 | ~~`9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/test_fourier.lean`, `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroCountScratch.lean`~~ | **Completed 8 August 2026:** deleted the isolated zero-valued Fourier toy and unused module-level symmetry assumption. | Easy—complete |
| 5 | ~~`9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/InghamBound.lean`~~ | **Completed 8 August 2026:** removed the unused Huxley premise so the statement matches the two-bound proof; deleted the stale, unreferenced `ScratchTransfer.lean` duplicate. | Easy—complete |
| 6 | ~~`9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean`~~ | **Completed and extended:** transitive checks cover 7,636 registered public declarations and all 14,290 discovered nonprivate theorems, including generated declarations; every publication/research-output gate passes. | Easy–moderate—complete |
...
- [x] `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/TestAxiom.lean` — deleted 8 August 2026 after confirming that no module imported or referenced its declarations
...
- [x] `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/test_fourier.lean` and `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroCountScratch.lean` — deleted 8 August 2026 after confirming that canonical code did not import or use them
...
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/RiemannZeta.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/InghamBound.lean`
...
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroCount.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroDetector.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/Decoupling.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/DirichletPolynomial.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ExponentArithmetic.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ExtractSeparated.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/MeanValue.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/HalaszMontgomery.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/InghamBound.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/Pigeonhole.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/PolynomialPowers.lean`
- `run_lake_build.bat`
...
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/HalaszMontgomery.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ExtractSeparated.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/BetaDependence.lean`
...
**File:** `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/Transfer.lean`
...
This phase is exactly Checklist #15–#18:
...
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/Decoupling.lean`
- `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/LargeValues.lean`
- additional focused modules introduced only when they represent real mathematical responsibilities

**Required actions—Checklist #19:**
...
**Required actions—final acceptance portion of Checklist #19:**
...
### Completed Iteration: Checklist #1

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/TestAxiom.lean` |
...
| Remaining obstruction | Proceed to Checklist #2: remove or repair the stale admitted representative-selection experiments. |

### Completed Iteration: Checklist #2
...
| Verification | Confirmed all seven paths are absent and no Lean file references `ExtractSeparated_scratch` or `representative_selection`. The remaining code-level `sorry` scan now finds five terms: one each in the three Checklist #3 tests and two in `PolynomialPowers.lean`. The default `lake build` completed successfully with the previously documented `powCoeffBound_native` `sorry` warning and unrelated linter warnings. |
| Documentation | Marked rank 2 and its Phase 0 entry complete in this agenda. |
| Remaining obstruction | Proceed to Checklist #3: repair or remove `TestExp.lean`, `test_separated.lean`, and `test_zeta.lean`. |

### Completed Iteration: Checklist #3
...
| Dependencies | Historical layout: `TestExp.lean` used Mathlib complex exponential facts and `test_separated.lean` imported `RiemannZeta.GuthMaynard.Separated`. After the map-oriented flattening, the retained regression imports `GuthMaynard.Separated`; the declaration namespace remains `RiemannZeta.GuthMaynard`. |
| Verification | `lake env lean TestExp.lean` and `lake env lean test_separated.lean` both completed successfully. `#print axioms separated_selection` reports only `propext`, `Classical.choice`, and `Quot.sound`. A code-level scan now finds exactly two remaining `sorry` proof terms, both in `PolynomialPowers.lean`; `test_zeta.lean` is absent. The principal runner logged to `logs/overall_proof_20260808_042042.log`: the default build passed, the known omitted production modules failed, the current audit module executed, and the global result correctly remained `FAIL` because of later Checklist defects. |
| Documentation | Marked rank 3 and its Phase 0 entry complete in this agenda. |
| Remaining obstruction | Proceed to Checklist #4: remove or repair `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/test_fourier.lean` and `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroCountScratch.lean`. |

### Completed Iteration: Checklist #4

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/test_fourier.lean` and `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroCountScratch.lean` |
...
| Verification | Confirmed both paths are absent, no Lean file references either scratch module or `zeroCountRect_symm`, and no zero-valued `fourierTransformΦ` definition remains. The code-level `sorry` scan still finds only the two terms in `PolynomialPowers.lean`. The principal runner logged to `logs/overall_proof_20260808_042738.log`: the default build passed; omitted production modules, prohibited-proof/axiom gates, and audit-quality gate correctly failed for later Checklist items; the overall result remained `FAIL`. |
| Documentation | Marked rank 4 and its Phase 0 entry complete in this agenda. |
| Remaining obstruction | Proceed to Checklist #5: align the unused Huxley premise and documentation in `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/InghamBound.lean`. |

### Completed Iteration: Checklist #5

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/InghamBound.lean`; obsolete duplicate `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ScratchTransfer.lean` |
...
| Verification | `lake env lean "9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/InghamBound.lean"` completed successfully (with only deprecation/style warnings). `#print axioms RiemannZeta.GuthMaynard.combined_zero_density_transfer_native` reports only `propext`, `Classical.choice`, and `Quot.sound`. Repository search confirmed that no code references the deleted scratch module and no documentation still describes the transfer as using three bounds. The principal runner logged to `logs/overall_proof_20260808_043258.log`: the default build and current audit-module execution passed; omitted production modules, the global `sorry`/axiom gates, and the audit-quality gate correctly failed for later Checklist items; the overall result remained `FAIL`. |
| Documentation | Updated `Research Agenda Progress.MD`, rank 5, and the Phase 1 action in this agenda. |
| Remaining obstruction | Proceed to Checklist #6: replace `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean` with a genuine dependency audit. |

### Completed Iteration: Checklist #6

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean`, with compilation-enabling repairs in `HalaszMontgomery.lean`, `Decoupling.lean`, and `LargeValues.lean` required for complete import coverage |
...
| Remaining obstruction | Proceed to Checklist #7: add the now-compiling production modules to the default `RiemannZeta` root import graph. |

### Completed Iteration: Checklist #7

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/RiemannZeta.lean`, `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean`, and the production-coverage stage in `run_lake_build.bat` |
...
| Remaining obstruction | Proceed to Checklist #8: eliminate all Lean warnings and enforce the runner's zero-warning gate. |

### Completed Iteration: Checklist #8

| Field | Record |
|---|---|
| Target | Eleven warning-producing production modules, `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean`, retained `scratch_pow.lean`, and `run_lake_build.bat` |
...
| Documentation | Updated `README.md`, `Paper_Riemann_Zeta.md`, `Research Agenda Progress.MD`, `Analytic Research Agenda.md`, rank 8, and the affected later Checklist entries. |
| Remaining obstruction | Proceed to Checklist #9: prove support and magnitude properties for the actual truncated Möbius detector. |

### Completed Iteration: Checklist #9

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroDetector.lean` and its synchronized entries in `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean` |
...
| Constant dependency | The existing proposition orders its quantifiers as `∀ ε, ∀ T, ∃ C, ∀ n`, so the proved constant is uniform in positive `n` for each fixed `T` and may depend on `T`. A stronger constant uniform in `T` is not claimed and is tied to the general divisor-function obligation in Checklist #10. |
...
| Remaining obstruction | Proceed to Checklist #10: prove the powered-coefficient estimate from faithful detector/divisor inputs and remove `k_divisor_function_bound`. |

### Completed Iteration: Checklist #10

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/PolynomialPowers.lean`, its synchronized entries in `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean`, and the polynomial-power documentation. |
...
| Remaining obstruction | Checklist #10 is complete at the honest finite/conditional boundary. Checklist #14 now uses the completed expansion and bound; `DivisorCountBoundProp` and `FactorizationCountBoundProp` remain unproved Goal C inputs. |

### Completed Iteration: Checklist #11

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/MeanValue.lean`, the mean-value-dependent theorem in `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/HalaszMontgomery.lean`, and their synchronized audit entries |
...
| Verification | Historical pre-flattening commands built `RiemannZeta.GuthMaynard.MeanValue` and `RiemannZeta.GuthMaynard.HalaszMontgomery`; their current-layout equivalents are `GuthMaynard.MeanValue` and `GuthMaynard.HalaszMontgomery`. The full default `lake build` and direct elaboration of `scratch_pow.lean` succeeded with zero Lean warnings. The principal runner logged to `logs/overall_proof_20260808_094027.log`: the default and explicit production builds passed with zero warnings; the synchronized audit correctly failed on 18 remaining project-axiom dependencies; the prohibited-placeholder, unsafe-bypass, and audit-quality scans passed; and the project-axiom scan correctly failed on 24 remaining declarations. The complete historical run exited `1`; the current completion status is stated at the top of this document. |
...
| Remaining obstruction | Proceed to Checklist #12: repair the Type II boundary and remove `typeII_bound_unconditional` while proving every finite consequence available from explicit inputs. The independent proof of `MontgomeryMeanValue` remains later Goal C work. |

### Pre-Implementation Source Audit: Checklist #12
...
| Incorrect dependency claim | `typeII_bound_of_halasz_montgomery_native` does not use `HalaszMontgomeryLemma`; it merely returns `typeII_bound_unconditional`. The Maynard–Pratt proof of Lemma 24 does not proceed from the discrete mean-value consequence proved in Checklist #11. |
...
### Completed Iteration: Checklist #12

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroDetector.lean`, `ExtractSeparated.lean`, `HalaszMontgomery.lean`, `TypeIIZeros.lean`, `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/RiemannZeta.lean`, and `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean` |
...
| Remaining obstruction | Checklist #12 is complete at the honest conditional/concrete boundary. Goal C must prove the source coverage, Appendix C reduction, and twisted fourth moment independently; #12 makes no unconditional claim for Maynard–Pratt Lemma 24. |

### Pre-Implementation Source and Interface Audit: Checklist #13
...
### Completed Implementation Record: Checklist #13

| Field | Completed result |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ExtractSeparated.lean`, with supporting changes in `Separated.lean`, `ZeroDetector.lean`, `ZeroCount.lean`, and `Audit.lean` |
...
### Critical Re-Audit and Reopened Plan: Checklist #13
...
### Completed Reopened Iteration: Checklist #13

| Field | Completed result |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ExtractSeparated.lean`, `DirichletPolynomial.lean`, `Audit.lean`, and synchronized project documentation. |
...
### Completed Reopened Iteration: Checklist #2
...
| Result | Deleted 30 obsolete auxiliary Lean files: 21 under `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard`, eight tracked root utilities/tests, and the ignored stale `scratch/Test.lean`. Retained only `TestExp.lean` and `test_separated.lean`. The tree now contains 30 Lean files total and no zero-byte Lean file. |
...
| Remaining obstruction | None for #2. Checklist #8's runner-coverage follow-up is completed in the next record. |

### Completed Reopened Iteration: Checklist #8
...
| Remaining obstruction | #8 has no remaining warning or retained-file coverage defect. At the current #14 revision, the overall runner cannot pass until later Checklist items remove the 4 audited dependency failures and all 13 direct project axioms. |

### Completed Reopened Iteration: Checklist #9

| Field | Record |
|---|---|
| Target | `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroDetector.lean`, `PolynomialPowers.lean`, and their synchronized audit/documentation entries. |
...
### Source and Interface Audit: Checklist #14
...
The #15–#19 internal proof contract is satisfied. Checklist #20 is now the active external-digestion layer: #20a is complete internally, while expert exposition review, independent semantic review, any separately authorized preprint/peer-review process, and canonicalization remain open. These gates cannot be closed by another runner PASS or by project-internal prose alone.
