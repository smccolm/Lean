...
| Canonical quiet verifier | **Complete internally** | `scripts/verify_release.ps1` is used locally and by the optional CI wrapper; it fails on warnings, tactic suggestions, linter findings, proof escapes, contract mismatches, audit failures, and unclassified modules. |
| Provenance and optional CI | **Complete locally; hosted mirror inconclusive and non-blocking** | Release mode refuses dirty trees and records SHA, branch, paths, time/timezone, Lean/Lake/toolchain/dependencies, verifier hash, contract version, classifications, and stages. GitHub runs `33258211182` and `33278864901` ended with external exit `143` before artifact upload; neither produced a Lean diagnostic or hosted PASS. This is recorded as missing supplemental evidence, not as a defect in the locally verified release. |
...
| Clean-clone tagged release | **Complete at the local release gate** | Exact commit `2ace9e7c09a69fdcd1edae1ab6deb7cb3b4df1be`, published annotated tag `gm-foundation-freeze-v1.0.1`, passed the canonical release verifier from a fresh short-path clone. Hosted CI remains optional supplemental evidence and has not produced a successful artifact. |
...
| Remaining obstruction | Proceed to Shitlist #4: remove or repair `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/test_fourier.lean` and `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/ZeroCountScratch.lean`. |
...
| Remaining obstruction | Proceed to Shitlist #5: align the unused Huxley premise and documentation in `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/GuthMaynard/InghamBound.lean`. |
...
| Remaining obstruction | Proceed to Shitlist #6: replace `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean` with a genuine dependency audit. |
