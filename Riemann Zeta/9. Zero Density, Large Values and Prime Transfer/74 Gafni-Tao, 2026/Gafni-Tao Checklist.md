...
The exact pins and local PNT+ derivation are in
...
- [x] **GT-00 - Isolation and source freeze.** The package lives entirely
  under `9. Zero Density, Large Values and Prime Transfer/74 Gafni-Tao, 2026`; the frozen foundation is the archived source of tag
...
- [x] **GT-26 - Documentation and reproduction.** The Architecture, Research
  Agenda, Crosswalk, Checklist, Sources, README, source hashes, reproduction
