...
call :run_lake "2/5 Explicit production-module coverage" build RiemannZeta.GuthMaynard.DyadicTransfer RiemannZeta.GuthMaynard.CentralTypeI RiemannZeta.GuthMaynard.HalaszMontgomery RiemannZeta.GuthMaynard.ClassicalArgumentPrinciple RiemannZeta.GuthMaynard.Decoupling RiemannZeta.GuthMaynard.LargeValues
