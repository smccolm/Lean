...
- **Focused Axiom/Output Audit Command**: `lake env lean RiemannZeta/Audit.lean` (1259/1259 existing dependency checks pass; the command exits nonzero on seven missing research outputs)
