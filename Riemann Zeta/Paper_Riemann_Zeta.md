...
- **Focused Axiom/Output Audit Command**: `lake env lean RiemannZeta/Audit.lean` (1198/1198 existing dependency checks pass; the command exits nonzero on seven missing research outputs)
