...
/-!
# Exact power-to-Bernstein conversion

This module proves the conversion formula used by the Ford numerical
certificate.  The proof is uniform in the degree.  In particular, generated
certificate files need only verify rational coefficient signs; they do not
carry enormous proof terms obtained by expanding degree-88 identities with
`ring`.
-/
