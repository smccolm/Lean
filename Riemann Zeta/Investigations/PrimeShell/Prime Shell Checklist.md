...
- [x] **PSH-00 — Isolation boundary.** All work is under `Investigations/PrimeShell/`; `RiemannZeta/` and `RiemannZeta.lean` are untouched by Prime Shell and no Prime Shell module enters the frozen root graph.
