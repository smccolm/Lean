...
3. Keep its integrity scans synchronized with `AGENTS.md` and its audit stage synchronized with `9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean`.
...
`9. Zero Density, Large Values and Prime Transfer/71 Guth-Maynard, 2026/Audit.lean` must be an actual dependency audit, not a categorization by declaration name or declaration kind.
